            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent"><input type="text" name="factoryName" value="${factory.factoryName}"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <%--备注这个值为什么没有显示--%>
                        <td class="tableContent"><textarea name="cnote" style="height:120px;"
                                                           value="${factory.cnote}"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
