            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent"><textarea name="seller" style="height:120px;">${obj.seller}</textarea>
                        </td>
                        <td class="columnTitle_mustbe">买方：</td>
                        <td class="tableContent"><textarea name="buyer" style="height:120px;">${obj.buyer}</textarea>
                        </td>
                    </tr>
                    <tr>
