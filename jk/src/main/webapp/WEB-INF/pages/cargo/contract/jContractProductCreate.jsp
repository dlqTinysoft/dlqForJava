...
<body>
<form method="post">
    <%--为了springMVC把其封装到ContractProduct中--%>
    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#" onclick="formSubmit('${ctx}/cargo/contract_product/insert.action','_self');">确定</a></li>
                ...
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent">
                            <%--把生产厂家的factoryId封装到contractProduct中--%>
                    ...
                    <table id="ec_table" class="tableRegion" width="98%" >
                        ...
                        <c:forEach items="${dataList}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>${o.amount}</td>
                                <td>
                                    <a href="toupdate.action?contractProductId=${o.id}">[修改]</a>
