...
// Tree object typeBox{radio:��ѡ / relationck:��ѡ ѡ���ӽڵ㸸�ڵ��Զ���ѡ�� / checkbox: ��ѡ�ڵ�} update by tony 20100915
// inputId:�����ύ�������������
// ��������id������td��ͷ 'td'+inputId ����һ��ҳ������ж����
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (this.config.useBox && nodeId != 0) {
        ...
        if (this.config.typeBox == "relationck") { //����ѡ��ʱ,checkbox name������id,����ִ�������� by tony 2010.10.29
